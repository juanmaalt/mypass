...
function createWindow() {
  ...
  //Clears all the persistence of the project
  mainWindow.on("close", () => {
...
// By default Electron will cancel all authentications, so you need to add a listener
// for the login event to override the default behavior.
